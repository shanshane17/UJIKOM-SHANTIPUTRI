    ...
    <div class="container bg-white rounded pt-4 pb-4">
        <div class="row">
            ...
            <div class="col-md-4 col-sm-12 text-left">
                <h5>Contact Info</h5>
                <p>Untuk info lebih lanjut, Anda dapat menghubungi beberapa kontak dibawah ini:</p>
                <i class="fa fa-tty"></i> 08 0000 1111 2222 <br>
                <i class="fa fa-envelope"></i> medkita@gmail.com <br>
                <i class="fa fa-hourglass"></i> Monday - Saturday (08.00 - 17.00) <br>
                <i class="fa fa-map-marker"></i> Jl.Suka Km 04 <br>
