    ...
    <footer>
        <div class="page-footer font-small indigo  bg-primary mt-3">
            <div class="container-fluid text-center text-md-left">
                <div class="row text-white">
                    <div class="col-md-2 mx-auto">
                        ...
                        MedKita adalah toko online yang menyediakan berbagai alat kesehatan berkualitas tinggi untuk mendukung 
                        kesehatan dan kesejahteraan Anda.<br>
                    ...
                    <div class="col-md-2 mx-auto">
                        ...
                        <ul class="list-unstyled">
                            +62 0000 1111 2222 <br>
                            medkita@gmail.com <br>
                            Jl.Suka Km 04
                        </ul>
                    </div>
                </div>
            ...
            <div class="footer-copyright text-center py-3 bg-dark text-white">©2024 Copyright :
                <a href="index.html"> medkita.tugassaya.com</a>
            </div>
        </div>
    </footer>
