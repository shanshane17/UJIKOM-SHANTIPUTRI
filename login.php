...
if (isset($_POST['login'])) {
    ...
    // Cek di tabel admin
    $queryAdmin = "SELECT * FROM tbl_admin WHERE username='$username'";
    $resultAdmin = mysqli_query($db, $queryAdmin);
    $admin = mysqli_fetch_assoc($resultAdmin);

    // Cek di tabel pelanggan
    $queryPelanggan = "SELECT * FROM tbl_pelanggan WHERE username='$username'";
    ...
    if ($pelanggan) {
        if ($password === $pelanggan['password']) {
            $_SESSION['user_id'] = $pelanggan['id_pelanggan'];
            ...
            echo "<script type='text/javascript'>swal('Login Gagal!', 'Username Anda Salah', 'info');</script>";
        }
    } else {
        echo "<script type='text/javascript'>swal('Login Gagal!', 'Password Anda Salah', 'info');</script>";
    }
}
?>
...
<body>
    <div class="signup-form">
        ...
        <div style="text-align: center;">
            <img src="admin/assets/images/logo-admin.png" height="72" alt="logo">
        </div>
