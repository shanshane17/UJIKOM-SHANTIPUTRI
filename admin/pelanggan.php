                ...
                <table id="datatable" class="table table-striped dt-responsive nowrap table-vertical" width="100%"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index_admin.php?pages=pelanggan&id=<?php echo $data['id_pelanggan']; ?>" class="text-muted" data-toggle="tooltip"
...
if (isset($_GET['id']))
{
    ...
    if ($execHapus)
    {
        ...
        echo "<script>location='index_admin.php?pages=pelanggan';</script>";
    }
}
?>