...
if (isset($_GET['id']))
{
    ...
    if ($execHapus)
    {
        ...
        echo "<script>location='index_admin.php?pages=pos';</script>";
    }
}
?>
				...
				<table id="datatable" class="table table-striped dt-responsive nowrap table-vertical" width="100%"
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="index_admin.php?pages=ubah-pos&id=<?php echo $data['id_pos']; ?>" class="m-r-15 text-muted" data-toggle="tooltip"
									data-placement="top" title="" data-original-title="Edit"><i
										class="mdi mdi-pencil font-18"></i></a>
								<a href="index_admin.php?pages=pos&id=<?php echo $data['id_pos']; ?>" class="text-muted" data-toggle="tooltip"
