                ...
                <table id="datatable" class="table table-striped dt-responsive nowrap table-vertical" width="100%"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="index_admin.php?pages=detail-order&id=<?php echo $data['id_order']; ?>"
                            ...
                            <?php if ($data['status'] == 'Sudah Dibayar' || $data['status'] == 'Produk Diterima' || $data['status'] == 'Produk Dikirim') { ?>
                            <a href="index_admin.php?pages=pembayaran&id=<?php echo $data['id_order']; ?>"
