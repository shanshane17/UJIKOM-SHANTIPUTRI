    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="index_admin.php?pages=dashboard" class="waves-effect"><i
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="index_admin.php?pages=pos">Semua Pos</a>
                        </li>
                        <li>
                            <a href="index_admin.php?pages=tambah-pos">Tambah Baru</a>
                        </li>
                        <li>
                            <a href="index_admin.php?pages=kategori-pos">Kategori</a>
                        </li>
                    </ul>
                </li>
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="index_admin.php?pages=produk">Semua Produk</a>
                        </li>
                        <li>
                            <a href="index_admin.php?pages=tambah-produk">Tambah Baru</a>
                        </li> 
                        <li>
                            <a href="index_admin.php?pages=tambah-kategori">Kategori</a>
                        </li>
                    </ul>
                </li>
                <li>
                    <a href="index_admin.php?pages=pelanggan"><i class="mdi mdi-account"></i>Pelanggan</a>
                </li>
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            <a href="index_admin.php?pages=order">Semua Orderan<span
