...
if (isset($_GET['id']))
{
    ...
    $id = $_GET['id'];
    //menghapus data
    $queryHapus = "DELETE FROM tbl_kat_pos WHERE id_kategori='$id'";
            ...
            <div class="card-body">
                ...
                <?php
                    if(isset($_POST['tambah'])){
                        $nm = $_POST['nama'];
                        $insert = "INSERT INTO tbl_kat_pos (nm_kategori) VALUES ('$nm')";
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php $no=1; ?>
                                    <?php $ambil=$db->query("SELECT * FROM tbl_kat_pos"); ?>
                                    <?php while($pecah=$ambil->fetch_assoc()){ ?>
                                    <tr>
                                        <th scope="row"><?php echo $no; ?></th>
                                        <td><?php echo $pecah['nm_kategori'] ?></td>
                                        <td>
                                            <a href="index.php?pages=kategori-pos&id=<?php echo $pecah['id_kategori']; ?>"
