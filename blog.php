...
<div class="container bg-white rounded pt-4">
    ...
    <div class="row text-left mb-5">
        <?php
            $query="SELECT * FROM tbl_pos a JOIN tbl_kat_pos m ON a.id_kategori=m.id_kategori WHERE nm_kategori='emergency' ORDER BY Gambar asc LIMIT 1";
        ...
        <div class="col-md-8 col-sm-12">
            <div class="col">
                <h4 class="font-weight-bold"><span class="text-success">PRODUCT</span> FAVORIT</h4>
                <hr align="left">
            </div>
            <div class="imgup mb-2"> <img src="admin/assets/images/foto_pos/<?php echo $data['gambar'];?>"
                    height="400px" width="100%" alt="..."></div>
            <h5>
    ...
    <div class="Bawah">
        <div class="row">
            <div class="col">
                <h4 class="font-weight-bold"><span class="text-success">PRODUCT</span> CATEGORY</h4>
                <hr align="left">
            </div>
        </div>
        <div class="row mb-3">
